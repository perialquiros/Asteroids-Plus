...
class PlayerCoOp(pygame.sprite.Sprite,):
    ...
    def handle_input(self):
        ...
        if(self.playerNum==1):
            if keys[pygame.K_SPACE] and time_since_last_shot >= 600:  # Shoot only if 600 milliseconds (0.6 second) have passed since the last shot
        ...
        if(self.playerNum==2):
            if keys[pygame.K_LSHIFT] and time_since_last_shot >= 600:
